...
import datetime
import pytz
end_datetime = datetime.datetime(2024, 3, 7, 10, 30, 0) #
...
# if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   # if(x.strftime("%X"))>(g.strftime("%X")):
    # print('\n\n')
    # print("     "+'خلص اشتراك عليك مراجعة صانع اداة@ABOS_PYT')
    # print('\n\n')
    # print(x)
...
def banner():
	...
	print('• DeCoDe By @A_B_A_S64 •')
	print('—'*25)
	print(L+f'''to  -  @A_B_A_S64  @ABOS_PYT  -  ارسل صور صيد لـ عۣۗہبوسہي ''')
	print('—'*25)
	print('• DeCoDe By @A_B_A_S64 •')
	print('—'*25)
def llogin():
...
def menu(my_name,my_id):
	...
	banner()
	print(B+'°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°')
	print(L+'  فقط لمشتركين عۣۗہبوسہي V I P اداة     ')
	print(L+'PY  -  𓆩𝐀𝐁𝐎𝐒𝐒𓆪 new update ')
	print(B+'°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°')
	print(L+f'»  Your ID : '+str(my_id))
	print(L+f'»  Your IP : {ip}')
	print(B+'°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°')
	...
	_____alvino__adijaya_____ = input(S+'\n[=] chose : ')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [𓆩𝐀𝐁𝐎𝐒𝐒𓆪] %s/%s ➙ [ [OK] %s ➙\033[1ll [ [CP] %s .. } %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
❖ - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
❖ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
𓆩𝐀𝐁𝐎𝐒𝐒𓆪 Get you an inactive account ❌
⋘─────━𓆩𝐀𝐁𝐎𝐒𝐒𓆪‏━─────⋙
♚ ☞ @A_B_A_S64  -  @ABOS_PYT - @A_B_A_S64'''
					statuscp1 = nel(statuscp, style='red')
					cetak(nel(statuscp1, title='عۣۗہبوسہي جابلك حساب سكيور '))
...
❖ - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
❖ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
𓆩𝐀𝐁𝐎𝐒𝐒𓆪 Get yourself a working account ✅
⋘─────━𓆩𝐀𝐁𝐎𝐒𝐒𓆪━─────⋙
♚ ☞ @A_B_A_S64  -  @ABOS_PYT - @A_B_A_S64'''
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title=' عۣۗہبوسہي جابلك حساب شغال '))
